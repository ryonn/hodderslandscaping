 ...
 */
function drupal_theme_61_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function drupal_theme_61_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function drupal_theme_61_button($element) {
 ...
 * Using styles in IE
*/
function drupal_theme_61_img_assist_page($content, $attributes = NULL) {
